...
import com.example.artbooktesting.adaper.ImageRecyclerAdapter
...
class ImageApiFragmentTest {
    ...
    fun selectImage(){
        ...
        val _selectedImageUrl = "imageUrl"
        ...
        Navigation.setViewNavController(requireView(), navController)
            ...
            imageRecyclerAdapter.images = listOf(_selectedImageUrl)
        }
        ...
        assertThat(testViewModel.selectedImageUrl.getOrAwaitValue()).isEqualTo(_selectedImageUrl)
    }
}